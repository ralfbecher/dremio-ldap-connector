...
/**
 * A simple ResultSet that returns a single row with a single value.
 * Used for metadata queries like getTableTypes().
 */
public class SingleValueResultSet implements ResultSet {
    private final String columnName;
    private final String value;
    private int currentRow = 0;  // 0 = before first, 1 = on row, 2 = after last
    private boolean closed = false;

    public SingleValueResultSet(String columnName, String value) {
    ...
    public String getString(int columnIndex) throws SQLException {
        if (currentRow != 1) throw new SQLException("No current row");
    ...
    public String getString(String columnLabel) throws SQLException {
        if (currentRow != 1) throw new SQLException("No current row");
        if (columnName.equalsIgnoreCase(columnLabel)) return value;
        throw new SQLException("Invalid column: " + columnLabel);
    }

    @Override
    public int findColumn(String columnLabel) throws SQLException {
        if (columnName.equalsIgnoreCase(columnLabel)) return 1;
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new ResultSetMetaData() {
            ...
            @Override public String getColumnLabel(int column) { return columnName; }
            @Override public String getColumnName(int column) { return columnName; }
    ...
    @Override public boolean isAfterLast() throws SQLException { return currentRow == 2; }
    @Override public boolean isFirst() throws SQLException { return currentRow == 1; }
    @Override public boolean isLast() throws SQLException { return currentRow == 1; }
    @Override public void beforeFirst() throws SQLException { currentRow = 0; }
    @Override public void afterLast() throws SQLException { currentRow = 2; }
    @Override public boolean first() throws SQLException { currentRow = 1; return true; }
    @Override public boolean last() throws SQLException { currentRow = 1; return true; }
    @Override public int getRow() throws SQLException { return currentRow == 1 ? 1 : 0; }
